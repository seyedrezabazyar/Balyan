                            ...
                            <div class="col-sm-6 footer-links-column">
                                ...
                                <nav aria-label="خدمات کاربران">
                                    <ul class="footer-links">
                                        <li><a href="{{ route('ebook.guide') }}"><i class="fas fa-file-pdf" aria-hidden="true"></i>باز کردن فایل کتاب</a></li>
                                        <li><a href="{{ route('tracking') }}"><i class="fas fa-shipping-fast" aria-hidden="true"></i>پیگیری سفارش</a></li>
