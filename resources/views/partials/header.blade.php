                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end animated fadeIn" aria-labelledby="userDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('profile.index') }}"><i class="fas fa-user me-2 text-primary" aria-hidden="true"></i> پروفایل</a></li>
                                <li><a class="dropdown-item" href="{{ route('profile.my-books') }}"><i class="fas fa-book me-2 text-info" aria-hidden="true"></i> کتاب‌های من</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
